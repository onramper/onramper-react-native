...
/**
 * Wraps a Swift `(_ count: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.onramper.bridge.swift

  private let closure: (_ count: Double) -> Void

  public init(_ closure: @escaping (_ count: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(count: Double) -> Void {
    self.closure(count)
  }
